...
function CustomHeader() {
  return (<header className="flex justify-between items-center py-4 md:py-8">
    ...
    <div className="hidden lg:flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5 -ml-8">
      <a href="#" className="inline-block bg-indigo-600 hover:bg-indigo-800 active:bg-indigo-800 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Ask a Question</a>
    </div>
    <div className="hidden lg:flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5 -ml-8">
